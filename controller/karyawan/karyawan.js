    ...
    getEmployees = (request, response) => {
        ...
        if (status === 'all') {
            ...
            "CASE a.StatusAktif " +
                "WHEN '1' THEN 'ACTIVE' " +
                "ELSE 'NOT ACTIVE' " +
            "END As StatusAktif2, b.KODE_UNIT, SUBSTRING(a.Alamat1, 1, 20) As Alamat, Case a.StatusKry When '1' Then 'OFFISIAL' When '5' Then 'RELAWAN' End As StatusKaryawan, a.KodeNik As value, CONCAT(a.NamaKry, ' - ', a.KodeNik) As label, c.CODD_DESC As TypeRelawan, e.NAMA_GRPX, e.KODE_URUT As KodeUrutGroup " + 
            ...
            if (typePerson === '4') {   // 4: Offisial
                ...
                "CASE a.StatusAktif " +
                    "WHEN '1' THEN 'ACTIVE' " +
                    "ELSE 'NOT ACTIVE' " +
                "END As StatusAktif2, b.KODE_UNIT, SUBSTRING(a.Alamat1, 1, 20) As Alamat, a.KodeNik As value, CONCAT(a.NamaKry, ' - ', a.KodeNik) As label, IFNULL(c.groupID, '') As groupID, Case a.StatusKry When '1' Then 'OFFISIAL' When '5' Then 'RELAWAN' End As StatusKaryawan, d.CODD_DESC As TypeRelawan, e.NAMA_GRPX, e.KODE_URUT As KodeUrutGroup " + 
            ...
            if (typePerson === '4') {   // 4: Offisial
                ...
                "CASE a.StatusAktif " +
                    "WHEN '1' THEN 'ACTIVE' " +
                    "ELSE 'NOT ACTIVE' " +
                "END As StatusAktif2, b.KODE_UNIT, SUBSTRING(a.Alamat1, 1, 20) As Alamat, a.KodeNik As value, CONCAT(a.NamaKry, ' - ', a.KodeNik) As label, IFNULL(c.groupID, '') As groupID, Case a.StatusKry When '1' Then 'OFFISIAL' When '5' Then 'RELAWAN' End As StatusKaryawan, d.CODD_DESC As TypeRelawan " + 
