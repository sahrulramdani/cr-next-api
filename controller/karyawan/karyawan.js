    ...
    getEmployees = (request, response) => {
        ...
        if (status === 'all') {
            ...
            "CASE a.StatusAktif " +
                "WHEN '1' THEN 'ACTIVE' " +
                "ELSE 'NOT ACTIVE' " +
            "END As StatusAktif2, b.KODE_UNIT, SUBSTRING(a.Alamat1, 1, 20) As Alamat, Case a.StatusKry When '1' Then 'OFFISIAL' When '5' Then 'RELAWAN' End As StatusKaryawan, a.KodeNik As value, CONCAT(a.NamaKry, ' - ', a.KodeNik, ' - ', SUBSTRING(a.Alamat1, 1, 20)) As label, c.CODD_DESC As TypeRelawan, e.NAMA_GRPX " + 
            "FROM tb21_empl a inner join tb00_unit b on a.BUSS_CODE = b.KODE_UNIT left join tb00_basx c on a.TypeRelawan = c.CODD_VALU And c.CODD_FLNM = 'TYPE_RELAWAN' left join vfirst_relawanDet d on a.KodeNik = d.RelawanID left join grpx_relx e on d.groupID = e.IDXX_GRPX where b.KODE_UNIT = '" + request.BUSS_CODE0 + "' order by a.NamaKry";
            ...
            if (typePerson === '1') {  // 1: Relawan
                switch(typeRelawan) {
                    ...
                    case '05' : // bendahara
                        ...
                        "WHEN '1' THEN 'ACTIVE' " +
                        "ELSE 'NOT ACTIVE' " +
                        "END As StatusAktif2, b.KODE_UNIT, SUBSTRING(a.Alamat1, 1, 20) As Alamat, Case a.StatusKry When '1' Then 'OFFISIAL' When '5' Then 'RELAWAN' End As StatusKaryawan, a.KodeNik As value, CONCAT(a.NamaKry, ' - ', a.KodeNik, ' - ', SUBSTRING(a.Alamat1, 1, 20)) As label, d.CODD_DESC As TypeRelawan, e.NAMA_GRPX " + 
                        "FROM tb21_empl a inner join tb00_unit b on a.BUSS_CODE = b.KODE_UNIT left join vfirst_relawandet c on a.KodeNik = c.RelawanID left join tb00_basx d on a.TypeRelawan = d.CODD_VALU And d.CODD_FLNM = 'TYPE_RELAWAN' left join grpx_relx e on c.RelawanID = e.IDXX_GRPX where b.KODE_UNIT like '" + request.BUSS_CODE0 + "' And c.groupID = '" + request.groupID + "' And a.StatusKry = '5' order by a.NamaKry";
                    ...
                    case '06' :
                        ...
                        "WHEN '1' THEN 'ACTIVE' " +
                        "ELSE 'NOT ACTIVE' " +
                        "END As StatusAktif2, b.KODE_UNIT, IFNULL(c.groupID, '') As groupID, a.KodeNik As value, CONCAT(a.NamaKry, ' - ', a.KodeNik, ' - ', SUBSTRING(a.Alamat1, 1, 20)) As label, d.NAMA_GRPX, Case a.StatusKry When '1' Then 'OFFISIAL' When '5' Then 'RELAWAN' End As StatusKaryawan, f.CODD_DESC As TypeRelawan, d.NAMA_GRPX " + 
            ...
            if (typePerson === '4') {   // 4: Offisial
                ...
                "CASE a.StatusAktif " +
                    "WHEN '1' THEN 'ACTIVE' " +
                    "ELSE 'NOT ACTIVE' " +
                "END As StatusAktif2, b.KODE_UNIT, SUBSTRING(a.Alamat1, 1, 20) As Alamat, a.KodeNik As value, CONCAT(a.NamaKry, ' - ', a.KodeNik, ' - ', SUBSTRING(a.Alamat1, 1, 20)) As label, IFNULL(c.groupID, '') As groupID, Case a.StatusKry When '1' Then 'OFFISIAL' When '5' Then 'RELAWAN' End As StatusKaryawan, d.CODD_DESC As TypeRelawan, e.NAMA_GRPX " + 
