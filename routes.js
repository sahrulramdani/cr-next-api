import * as C from './controller/index.js';
 ...
 const routes = (app) => {
      ...
      app.route('/crm/donatur/transaction/simpan').post(C.auth.verifyToken, C.donatur.saveDetTransaction2);
      app.route('/crm/donatur/transaction/save').post(C.auth.verifyToken, C.donatur.saveDetTransaction);
      app.route('/crm/donatur/transaction/wa/update').post(C.auth.verifyToken, C.donatur.updateDonaturTrans2);
      ...
      app.route('/crm/donatur/wa/update').post(C.auth.verifyToken, C.donatur.updateDonatur2);
      ...
      app.route('/crm/transaction/wa/payment_notification').post(C.auth.verifyToken, C.donatur.paymentWATransaction);
      ...
      app.route('/crm/transaction/item/simpan').post(C.auth.verifyToken, C.donatur.saveTransItemArray2);
